...
public class CANDriveSubsystem extends SubsystemBase {
    private final SparkMax leftLeader;
        private static final int LEFT_LEADER_ID = 0;
    private final SparkMax leftFollower;
        private static final int LEFT_FOLLOWER_ID = 0;
    private final SparkMax rightLeader;
       private static final int RIGHT_LEADER_ID = 0;
    private final SparkMax rightFollower;
        private static final int RIGHT_FOLLOWER_ID = 0;
                private static final int DRIVE_MOTOR_CURRENT_LIMIT = 0;
            private final DifferentialDrive drive;
          
            public CANDriveSubsystem() {
              //create kBrushless motors for drive
