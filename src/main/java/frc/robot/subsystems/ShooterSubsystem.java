...
public class ShooterSubsystem extends SubsystemBase {
    ...
    /**
     * This subsytem that controls the shooter.
     */
    public ShooterSubsystem () {

    // Set up the arm motor as a brushed motor
        SparkMax armMotor = new SparkMax(ShooterConstants.Shooter_MOTOR_ID, MotorType.kBrushless);
    ...
    armConfig.smartCurrentLimit(ShooterConstants.Shooter_MOTOR_CURRENT_LIMIT);
